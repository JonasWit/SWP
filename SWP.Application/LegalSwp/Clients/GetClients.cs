...
namespace SWP.Application.LegalSwp.Clients
{
    ...
    public class GetClients : LegalActionsBase
    {
        ...
        public List<Client> GetClientsWithoutData(string claim, List<int> allowedIds, bool active = true) => _legalManager.GetClientsWithoutCases(claim, allowedIds, active);
